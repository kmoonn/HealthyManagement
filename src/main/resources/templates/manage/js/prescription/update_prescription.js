function update_pre(id){
    /*处方名称*/
           ...
           if(strength==2)
           {
            ...
            uploadUserInfo(id,pre_name,pre_time,strength01,pre_min_heart,pre_max_heart,pre_weight,pre_number,
...
function uploadUserInfo(id,pre_name,pre_time,strength01,pre_min_heart,pre_max_heart,pre_weight,pre_number,
                                pre_group_num,pre_frequency,sport_type,fatigue,effect,equipment,disease,pre_ways,pre_cycle,pre_address,pre_notice){
        /*var like;
        for(var i=0;i<strSel.length;i++)
        {
    ...
    $.ajax({
                    type:"POST",
                    url:"standardRecipe/updateSR.do",
                    data:formData,
