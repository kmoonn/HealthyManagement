                                ...
                                success:function (data) {
                                       ...
                                       var mydata = data;
                                                   ...
                                                   $("#table_list_2").jqGrid({
                                                       ...
                                                       rowNum: 20,
                                                       rowList: [10, 20, 30],
                                                       colNames: ['id','处方名称', '疲劳度等级', '运动类型', '运动频率', '运动器材', '评测周期', '运动时间','运动效果','注意事项'],
                                                       colModel: [
                                                       {
                                                          name: 'id',
                                                          index: 'id',
                                                        ...
                                                        },
                                                        {
                                                           ...
                                                           {
                                                               name: 'sportsMustEquipmentList',
                                                               index: 'sportsMustEquipmentList',
                                                               editable: true,
                                                               width: 90,
                                                           ...
                                                           {
                                                               name: 'sportsEffectList',
                                                               index: 'sportsEffectList',
                                                               editable: true,
                                                               width: 90,
