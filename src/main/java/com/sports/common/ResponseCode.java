...
public enum ResponseCode {
    ...
    PARAM_PARSE_ERROR(1005,"参数格式转化错误"),
    TIME_PARAM_PARSE_ERROR(1006,"时间参数格式转化错误"),
    ...
    USER_PASSWORD_EQUALLY(20006,"原密码与新密码不能相同"),
    USER_NAME_HAS_EXISTED(20007, "用户名已存在"),
    ...
    ID_ALREADY_EXISTED(50004,"设备编号已存在"),
    ID_IS_INVALID(50005,"设备编号格式错误"),
    ...
    TIME_ERROR(70008, "时间错误"),

    /* 处方错误：80001-89999*/

    RECIPE_NAME_HAS_EXISTED(80001, "处方名已存在");
