...
public class PublicSite {
    ...
    public void setSportEvent(String sportEvent) {
        this.sportEvent = sportEvent == null ? null : sportEvent.trim();
    }
    ...
    public Double getRecommendaRate() {
        return recommendaRate;
    }

    public void setRecommendaRate(Double recommendaRate) {
        this.recommendaRate = recommendaRate;
    }
